...
/** Parameter of [[ICache]].
  ...
  * @param tagECC tag ECC, will be parsed to [[rocketchipnpu.util.Code]].
  * @param dataECC data ECC, will be parsed to [[rocketchipnpu.util.Code]].
...
class ICache(val icacheParams: ICacheParams, val staticIdForMetadataUseOnly: Int)(implicit p: Parameters) extends LazyModule {
  ...
  /** Rocket configuration has virtual memory.
    ...
    * see [[rocketchipnpu.amba.AMBAProt]] for more informations.
    */
